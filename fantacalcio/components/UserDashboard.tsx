...
// Edit icon for profile picture overlay
const EditIcon = () => (
    ...
    return (
        <aside className="bg-brand-surface p-4 rounded-lg shadow-lg w-full h-full flex flex-col">
            <div className="text-center mb-4 flex flex-col items-center">
                ...
                {/* Credits */}
                <div className="mt-2">
                    <p className="text-xs text-brand-subtle">Crediti Rimanenti</p>
            ...
            <div className="flex-grow overflow-y-auto pr-2 min-h-[300px]">
                <h4 className="font-semibold mb-2 text-brand-text text-center">Formazione ({user.squad.length}/25)</h4>
            ...
            {status === 'ENDED' && user.squad.length > 0 && (
                <div className="mt-4 pt-4 border-t border-slate-700">
                    <Button onClick={() => exportSquadToExcel(user.squad, user.name)} className="w-full">
                        Scarica Rosa (Excel)
                    </Button>
                </div>
            )}
