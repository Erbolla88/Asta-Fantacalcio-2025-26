...
const translations = {
  it: {
    ...
    adminSectionSpecialClip: '6. Clip Audio Utente Speciale',
    adminSpecialClipInstruction: 'Carica un file MP3 da riprodurre quando rich891@live.it vince un giocatore (o per ogni vincitore in modalità test).',
    adminChooseMp3: 'Scegli un MP3',
    adminUploadClip: 'Carica Clip',
    adminClipSuccess: 'Clip audio caricata con successo!',
    ...
    auctionStartingIn: 'L\'asta inizia tra',
    ...
    nextPlayerUp: 'Prossimo Giocatore...',
    ...
    errorClipForm: 'Seleziona un file MP3.',
  ...
  en: {
    ...
    adminSectionSpecialClip: '6. Special User Audio Clip',
    adminSpecialClipInstruction: 'Upload an MP3 file to be played when rich891@live.it wins a player (or for every winner in test mode).',
    adminChooseMp3: 'Choose an MP3',
    adminUploadClip: 'Upload Clip',
    adminClipSuccess: 'Audio clip uploaded successfully!',
    ...
    countdown: 'Countdown',
    auctionStartingIn: 'Auction starting in',
    ...
    errorClipForm: 'Please select an MP3 file.',
