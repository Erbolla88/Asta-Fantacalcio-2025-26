...
const translations = {
  it: {
    ...
    loginAdminInstruction: 'Admin: Clicca sulla tua card o su quella di un altro utente per entrare.',
    ...
    adminSectionAccess: '1. Gestione Accessi Utenti',
    ...
    adminSectionCredits: '5. Imposta Crediti Iniziali',
    adminInitializeAuction: 'Inizializza Asta',
    adminSectionStart: '6. Avvia Asta',
    adminUsersReady: '{count} / {total} utenti pronti.',
    adminWaiting: 'In attesa...',
    adminStartAuction: 'Avvia Asta',
    adminStartAuctionInstruction: 'Il pulsante si attiverà quando tutti gli utenti (incluso l\'admin che è già pronto) confermeranno.',
  ...
  en: {
    ...
    loginSubtitle: 'Monticelli 2025/26',
    loginAdminInstruction: 'Admin: Click on your card or another user\'s to enter.',
    ...
    adminSectionAccess: '1. User Access Management',
    ...
    adminSectionCredits: '5. Set Initial Credits',
    adminInitializeAuction: 'Initialize Auction',
    adminSectionStart: '6. Start Auction',
    adminUsersReady: '{count} / {total} users ready.',
    adminWaiting: 'Waiting...',
    adminStartAuction: 'Start Auction',
    adminStartAuctionInstruction: 'The button will be enabled when all users (including the admin, who is already ready) confirm.',
